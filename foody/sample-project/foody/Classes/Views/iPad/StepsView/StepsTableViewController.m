...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    StepsCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdentifier];
    ...
    [cell.dottedImageView setBackgroundColor:dottedColor];
    
    NSString* step = steps[indexPath.row];
